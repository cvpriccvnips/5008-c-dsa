...
//           ^ Note: You will get a few warnings for passing pointers around, and
...
// see questions in assignment about these constants
#define ROWS 5
#define COLUMNS 5
...
int isConnected(int* g, int node1, int node2){
    ...
    //     }
    // }
    return g[node1 * COLUMNS + node2]; //remove this line, it is present so the code compiles
}
